...
class VerificationRequestAdmin(admin.ModelAdmin):
    ...
    autocomplete_fields = ("user", "student_profile", "university", "faculty", "major", "academic_year", "semester", "reviewed_by")
...
class VerificationCardAccessTicketAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ("token", "verification", "requested_by", "expires_at", "max_uses", "use_count", "revoked_at", "created_at", "updated_at")
