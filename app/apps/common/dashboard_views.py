    ...
    def get(self, request):
        ...
        data = {
            ...
            "printing": {
                ...
                "pending_orders": PrintOrder.objects.filter(
                    status__in=[PrintOrderStatus.SUBMITTED, PrintOrderStatus.UNDER_REVIEW]
                ).count(),
            ...
            "feedback": {
                ...
                "open_items": AppFeedback.objects.filter(is_deleted=False)
                .exclude(status__in=[FeedbackStatus.RESOLVED, FeedbackStatus.REJECTED, FeedbackStatus.DUPLICATE])
                .count(),
