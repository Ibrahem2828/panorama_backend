...
class DashboardUserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            "is_active", "is_staff", "is_phone_verified", "is_email_verified",
            "date_joined", "last_login", "effective_capabilities", "overrides",
        ]
        read_only_fields = [
            "id", "username", "email", "phone_number", "is_staff", "is_phone_verified",
            "is_email_verified", "date_joined", "last_login", "effective_capabilities", "overrides",
        ]
    ...
    def update(self, instance, validated_data):
        ...
        if instance.role == UserRole.IT_SUPPORT and instance.is_active:
            ...
            if removing_last and not User.objects.filter(
                role=UserRole.IT_SUPPORT, is_active=True, is_deleted=False
